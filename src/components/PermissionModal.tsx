      ...
      >
        ...
        <p className="text-white/60 text-sm mb-6 leading-relaxed">
          { (window as any).Capacitor?.isNativePlatform() 
            ? "Zara needs microphone permission to hear you. Please enable it in your phone's App Settings."
            : "Your browser has blocked microphone access for this site. Zara cannot hear you until you allow it."
          }
        </p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-left w-full mb-8">
          ...
          { (window as any).Capacitor?.isNativePlatform() ? (
            <ol className="text-xs text-white/60 list-decimal pl-4 space-y-2">
              <li>Minimize the app and go to your Phone's <strong>Settings</strong>.</li>
              <li>Go to <strong>Apps</strong> {">"} <strong>Zara AI</strong> {">"} <strong>Permissions</strong>.</li>
              <li>Select <strong>Microphone</strong> and set it to <strong>Allow only while using the app</strong>.</li>
              <li>Re-open Zara and try again.</li>
            </ol>
          ) : (
            <ol className="text-xs text-white/60 list-decimal pl-4 space-y-2">
