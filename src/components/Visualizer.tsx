...
export default function Visualizer({ state }: VisualizerProps) {
  ...
  // JARVIS color palette (Cyan/Blue) with Zara's personality (Violet/Pink hints)
  const getTheme = () => {
    switch (state) {
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center overflow-hidden pointer-events-none">
      ...
      >
        {/* Center Text */}
        <div 
          className="font-sans font-bold tracking-[0.4em] text-xl md:text-3xl lg:text-4xl text-white"
